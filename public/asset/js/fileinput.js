...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            //noinspection HtmlUnknownAttribute 
            tBtnLink = '<a href="{href}" tabindex="500" style="display: none" title="{title}" class="{css}" {status}>{icon} {label}</a>';
            //noinspection HtmlUnknownAttribute
            ...
            tActionUpload = '<button type="button" style="display: none" class="{uploadClass}" title="{uploadTitle}">' +
                '{uploadIcon}</button>';
